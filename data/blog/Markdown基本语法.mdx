...
tags: ['markdown']
draft: false
summary: '关于Markdown基本语法的技术文章，包含详细的技术实现和最佳实践。'
---
...
这是《*[Markdown指南》](http://markdown.p2hp.com/index.html)*。
...
[文档markdown.p2hp.com/basic-syntax](http://markdown.p2hp.com/basic-syntax/)