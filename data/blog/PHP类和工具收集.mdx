...
tags: ['php', 'tools']
draft: false
summary: '关于PHP类和工具收集的技术文章，包含详细的技术实现和最佳实践。'
---

> * 原文地址：[PHP类和工具收集](https://github.com/logoove/phpclass)
...
- juhe 聚合短信发送和违章查询
- markdown md解析类
- pdo 一个提取自微擎中的pdo方式处理数据库的工具 [https://gitee.com/yoby/pdo](https://gitee.com/yoby/pdo)
