...
tags: ['git']
draft: false
summary: '关于【Git不要只会pull和push，试试这5条提高效率的命令】的技术文章，包含详细的技术实现和最佳实践。'
---

## Git不要只会pull和push，试试这5条提高效率的命令

### 转载链接：[出来吧皮卡丘](https://juejin.cn/post/7071780876501123085)
...
### reset --soft
官方文档
- [git 教程](https://www.bookstack.cn/read/git-tutorial/docs-commands-git-reset.md)
#### 描述
...
#### reflog
- [官方文档](https://git-scm.com/docs/git-reflog)
描述
