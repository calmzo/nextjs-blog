...
tags: ['system-design']
draft: false
summary: '关于系统设计入门的技术文章，包含详细的技术实现和最佳实践。'
---
...
![系统设计入门](http://qiniu.calmchen.com/blog/2022-07-19-jj3A5N8.png)
...
![系统设计入门](http://qiniu.calmchen.com/blog/2022-07-19-jrUBAF7.png)
...
![Imgur](http://qiniu.calmchen.com/blog/2022-07-19-xHGqW8.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-UXHgZi.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-JMmAvp.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-IOjgak.jpg)
![资料来源：维基百科](http://horicky.blogspot.com/2010/10/scalable-system-design-patterns.html)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-rCy9nn.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-5kcxZP.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-Cw3yh1.jpg)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-90GZl5.jpg)
![资料来源：可扩展性、可用性、稳定性、模式](http://www.slideshare.net/jboner/scalability-availability-stability-patterns/)
...
[Imgur](http://qiniu.calmchen.com/blog/2022-07-19-wQafDz.jpg)
![资料来源：扩展你的用户数到第一个一千万](https://www.youtube.com/watch?v=w95murBkYmU)
...
| 注销          | **POST** /resign<br/>`{"personid": "1234"}` | **DELETE** /persons/1234                 |
| 读取用户信息      | **GET** /readPerson?personid=1234        | **GET** /persons/1234                    |
| 读取用户物品列表    | **GET** /readUsersItemsList?personid=1234 | **GET** /persons/1234/items              |
| 向用户物品列表添加一项 | **POST** /addItemToUsersItemsList<br/>`{"personid": "1234", "itemid": "456"}` | **POST** /persons/1234/items<br/>`{"itemid": "456"}` |
| 更新一个物品      | **POST** /modifyItem<br/>`{"itemid": "456", "key": "value"}` | **PUT** /items/456<br/>`{"key": "value"}` |
| 删除一个物品      | **POST** /removeItem<br/>`{"itemid": "456"}` | **DELETE** /items/456                    |
